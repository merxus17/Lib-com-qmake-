...
namespace rm
{
class GraphicsSceneMoveEvent : public GraphicsSceneEvent
{
public:
	/**
	 * constructor
	 ...
	 * virtual destructor
	 */
    ~GraphicsSceneMoveEvent() = default;

    /**
     * @brief getButtons - Get integer that stores which buttons are pressed. Each bit represents one buttons.
     * These bits are consistent with the MouseButton enum definition.
     * @return - integer that stores which buttons are pressed.
     */
    ...
    /**
     * @brief setButtons - Set the integer that stores which buttons are pressed. Each bit represents one of buttons.
     * These bits are consistent with the MouseButton enum definition.
     * @param buttons - integer that stores which buttons are pressed.
     */
...
private:
    ...
    /**
     * Store the pressed buttons during the event. Each bit represents one buttons. These bits are consistent with the
